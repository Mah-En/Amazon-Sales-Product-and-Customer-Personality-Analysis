...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{Plots/Correlation Matrix.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{Plots/KDE Plot with Normal Curve Overlay.png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Distribution of Income.png}
        \caption{Distribution of Income}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Distribution of Age.png}
        \caption{Distribution of Age}
        \label{fig:sub2}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Income vs. Spending on Wine (by Education Level).png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\linewidth]{Plots/Distribution of Customer Education Level.png}
        \caption{Distribution of Customer Education Level}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\linewidth]{Plots/Campaign Acceptance by Education Level.png}
        \caption{Campaign Acceptance by Education Level}
        \label{fig:sub2}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth}
        \includegraphics[width=\linewidth]{Plots/Average Income by Education Level.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{Plots/Average Campaign Acceptance Rate by Marital Status.png}
...
\begin{figure}[h]
    \centering
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Box Plot of Age.png}
        \caption{Box Plot of Age}
        \label{fig:sub1}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Boxplot of Income.png}
        \caption{Boxplot of Income}
        \label{fig:sub2}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Income Distribution by Education Level.png}
        \caption{Income Distribution by Education Level}
        \label{fig:sub3}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Spending Behavior by children Status.png}
        \caption{Spending Behavior by children Status}
        \label{fig:sub4}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Spending Behavior by Marketing Campaign Participation.png}
        \caption{Spending Behavior by Marketing Campaign Participation}
        \label{fig:sub5}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\linewidth]{Plots/Spending on Wine by Marital Status.png}
